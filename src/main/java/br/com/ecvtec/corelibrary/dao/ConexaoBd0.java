...
public class ConexaoBd0 {
	

	private static final Log log = LogFactory.getLog(ConexaoBd0.class);
	...
	public static BasicDataSource getDataSource() throws SQLException {
		...
		try {
			...
			log.info("Criando DataSource Bd0:\n( " + (isRemoto ? "V" : "F") + " ) Remoto\n( " + (!isRemoto ? "V" : "F") + " ) Local");
			...
			String mydatabase = ConfigPropHelper.getValorPropriedadePorNome(isRemoto ? "databaseBd0" : "databaseBd0Local");
			String username = ConfigPropHelper.getValorPropriedadePorNome(isRemoto ? "userBd0" : "userBd0Local");
			String password = ConfigPropHelper.getValorPropriedadePorNome(isRemoto ? "passwordBd0" : "passwordBd0Local");
