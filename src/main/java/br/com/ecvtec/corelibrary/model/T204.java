...
public class T204 implements Serializable {
	...
	private T203Detalhe c4_204_203;
	...
	private String c13_204;
	 ...
	 /** Referencia ao campo ITEM (c5_206_204) da tabela FORM_TELA_ABA_ITEM_DETALHE (t206) */
	@JsonManagedReference("t206C5")
	@OneToMany(mappedBy = "c5_206_204", cascade=CascadeType.ALL, 
		fetch = FetchType.EAGER, orphanRemoval=true)
	private Set<T206Detalhe> t206C5;
	...
	/** Busca valor do campo referencia ITEM (c5_206_204) da tabela FORM_TELA_ABA_ITEM_DETALHE (t206) */
	public Set<T206Detalhe> getT206C5(){
		return this.t206C5;
	}

	/** Define valor do campo referencia ITEM (c5_206_204) da tabela FORM_TELA_ABA_ITEM_DETALHE (t206) */
	public void setT206C5(Set<T206Detalhe> t206C5){
		this.t206C5 = t206C5;
	}
	
	public void setFilhos(){
		if(this.t206C5 == null) return;
		for(T206Detalhe t206 : this.t206C5){
			t206.setC2_206_201(this.c2_204_201);
			t206.setC3_206_202(this.c3_204_202);	
			t206.setC4_206_203(this.c4_204_203);
			t206.setC5_206_204(this);
		}		
	}
