...
public class T203 implements Serializable {
	...
	private T202Detalhe c3_203_202;
	...
	private String c10_203;
	 ...
	 /** Referencia ao campo ABA (c4_204_203) da tabela FORM_TELA_ABA_ITEM (t204) */
	@JsonManagedReference("t204C4")
	@OneToMany(mappedBy = "c4_204_203", cascade=CascadeType.ALL, 
		fetch = FetchType.EAGER, orphanRemoval=true)
	private Set<T204Detalhe> t204C4;
	...
	/** Busca valor do campo referencia ABA (c4_204_203) da tabela FORM_TELA_ABA_ITEM (t204) */
	public Set<T204Detalhe> getT204C4(){
		return this.t204C4;
	}

	/** Define valor do campo referencia ABA (c4_204_203) da tabela FORM_TELA_ABA_ITEM (t204) */
	public void setT204C4(Set<T204Detalhe> t204C4){
		this.t204C4 = t204C4;
	}

	public void setFilhos(){
		if(this.t204C4 == null) return;
		for(T204Detalhe t204 : this.t204C4){
			t204.setC2_204_201(this.c2_203_201);		
			t204.setC3_204_202(this.c3_203_202);
			t204.setC4_204_203(this);
		}
	}
